describe 'Eligible::CalculatorDeployUrl' do
  ...
  describe '.fetch_or_create' do
    it 'should call Eligible.request with proper url' do
      ...
      expect(Eligible::CalculatorDeployUrl.fetch_or_create(params, api_key: api_key)).to eq 'success'
    end

    it 'should raise error if invalid api key is used' do
      expect { Eligible::CalculatorDeployUrl.fetch_or_create(params, api_key: api_key) }.to raise_error do |error|
