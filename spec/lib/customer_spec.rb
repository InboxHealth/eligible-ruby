describe 'Eligible::Customer' do
  ...
  describe '.get' do
    ...
    it 'should raise error if customer id is not present' do
      expect { Eligible::Customer.get(params, api_key: api_key) }.to raise_error(ArgumentError)
    end
  end
  ...
  describe '.update' do
    ...
    it 'should raise error if customer id is not present' do
      expect { Eligible::Customer.update(params, api_key: api_key) }.to raise_error(ArgumentError)
    end
  end
