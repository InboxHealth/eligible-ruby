describe 'Eligible::V1_0::InsuranceCompany' do
  ...
  describe '.retrieve' do
    it 'should call Eligible.request with proper url' do
      ...
      expect(Eligible::V1_0::InsuranceCompany.retrieve(params[:id], api_key: api_key)).to eq 'success'
    end

    it 'should raise error if insurance policy id is not present' do
      expect { Eligible::V1_0::InsuranceCompany.retrieve(nil, api_key: api_key) }.to raise_error(ArgumentError)
    end
  end
  ...
  describe '.list' do
    it 'should call Eligible.request with proper url' do
      ...
      expect(Eligible::V1_0::InsuranceCompany.list(params, api_key: api_key)).to eq 'success'
    end
  end

  describe '.create' do
    it 'should raises an exception saying not supported action' do
      expect { Eligible::V1_0::InsuranceCompany.create(params, api_key: api_key) }.to raise_error("Not an allowed operation for this endpoint")
    end
  end
