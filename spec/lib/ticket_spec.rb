describe 'Eligible::Ticket' do
  ...
  describe '.get' do
    it 'should call Eligible.request with proper url' do
      ...
      expect(Eligible::Ticket.get(params, api_key: api_key)).to eq 'success'
    end

    it 'should raise error if ticket id is not present' do
      expect { Eligible::Ticket.get(params, api_key: api_key) }.to raise_error(ArgumentError)
    end
  end
  ...
  describe '.delete' do
    it 'should call Eligible.request with proper url' do
      ...
      expect(Eligible::Ticket.delete(params, api_key: api_key)).to eq 'success'
    end

    it 'should raise error if ticket id is not present' do
      expect { Eligible::Ticket.delete(params, api_key: api_key) }.to raise_error(ArgumentError)
    end
  end
  ...
  describe '.comments' do
    it 'should call Eligible.request with proper url' do
      ...
      expect(Eligible::Ticket.comments(params, api_key: api_key)).to eq 'success'
    end

    it 'should raise error if ticket id is not present' do
      expect { Eligible::Ticket.comments(params, api_key: api_key) }.to raise_error(ArgumentError)
    end
  end
  ...
  describe '.create' do
    it 'should post to Eligible.request with proper url' do
      ...
      expect(Eligible::Ticket.create(params, api_key: api_key)).to eq 'success'
    end
  end
  ...
  describe '.update' do
    it 'should call Eligible.request with proper url' do
      ...
      expect(Eligible::Ticket.update(params, api_key: api_key)).to eq 'success'
    end

    it 'should raise error if ticket id is not present' do
      expect { Eligible::Ticket.update(params, api_key: api_key) }.to raise_error(ArgumentError)
    end
  end
  ...
  describe '.all' do
    it 'should call Eligible.request with proper url' do
      ...
      expect(Eligible::Ticket.all(params, api_key: api_key)).to eq 'success'
    end
  end
end
