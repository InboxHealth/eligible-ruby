describe 'Claim' do
  ...
  describe '.ack' do
    it 'should call Eligible.request with proper url' do
      ...
      expect(Eligible::Claim.ack(params, api_key: api_key)).to eq 'success'
    end

    it 'should raise error if reference id is not present' do
      expect { Eligible::Claim.ack(params, api_key: api_key) }.to raise_error(ArgumentError)
    end
  end
  ...
  describe '.post' do
    it 'should post to Eligible.request with proper url' do
      ...
      expect(Eligible::Claim.post(params, api_key: api_key)).to eq 'success'
    end
  end
  ...
  describe '.acks' do
    it 'should call Eligible.request with proper url' do
      ...
      expect(Eligible::Claim.acks(params, api_key: api_key)).to eq 'success'
    end
  end
  ...
  describe '.payment_report' do
    it 'should call Eligible.request with proper url when only reference id is given' do
      ...
      expect(Eligible::Claim.payment_report(params, api_key: api_key)).to eq 'success'
    end
    ...
    it 'should raise error if reference id is not present' do
      expect { Eligible::Claim.payment_report(params, api_key: api_key) }.to raise_error(ArgumentError)
    end
  end
  ...
  describe '.payment_reports' do
    it 'should call Eligible.request with proper url' do
      ...
      expect(Eligible::Claim.payment_reports(params, api_key: api_key)).to eq 'success'
    end
  end
end
