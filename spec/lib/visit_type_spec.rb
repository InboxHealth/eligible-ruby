describe 'Eligible::VisitType' do
  ...
  describe '.list' do
    it 'should call Eligible.request with proper url' do
      ...
      expect(Eligible::VisitType.list(params, api_key)).to eq 'success'
    end

    it 'should raise error if invalid api key is used' do
      expect { Eligible::VisitType.list(params, api_key) }.to raise_error do |error|
  ...
  describe '.insurance_company_ids' do
    it 'should call Eligible.request with proper url to get insurance_company_ids' do
      ...
      expect(Eligible::VisitType.insurance_company_ids(params, api_key)).to eq 'success'
    end
  end
end
