describe 'RiskAssessment' do
  ...
  describe '.criteria' do
    it 'should call Eligible.request with proper url' do
      ...
      expect(Eligible::RiskAssessment.criteria(params, api_key: api_key)).to eq 'success'
    end
  end
  ...
  describe '.cost_estimate' do
    it 'should call Eligible.request with proper url' do
      ...
      expect(Eligible::RiskAssessment.cost_estimate(params, api_key: api_key)).to eq 'success'
    end
  end
  ...
  describe '.fetch' do
    it 'should call Eligible.request with proper url' do
      ...
      expect(Eligible::RiskAssessment.fetch(params, api_key: api_key)).to eq 'success'
    end
  end
end
