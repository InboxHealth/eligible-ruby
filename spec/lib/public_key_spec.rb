describe 'Eligible::PublicKey' do
  ...
  describe '.get' do
    ...
    it 'should raise error if key id is not present' do
      expect { Eligible::PublicKey.get(params, api_key: api_key) }.to raise_error(ArgumentError)
    end
  end
  ...
  describe '.activate' do
    ...
    it 'should raise error if key id is not present' do
      expect { Eligible::PublicKey.activate(params, api_key: api_key) }.to raise_error(ArgumentError)
    end
  end
