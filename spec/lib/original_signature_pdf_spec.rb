describe 'Eligible::OriginalSignaturePdf' do
  ...
  describe '.get' do
    it 'should call Eligible.request with proper url' do
      ...
      expect(Eligible::OriginalSignaturePdf.get(params, api_key: api_key)).to eq 'success'
    end

    it 'should raise error if enrollment npi id is not present' do
      expect { Eligible::OriginalSignaturePdf.get(params, api_key: api_key) }.to raise_error(ArgumentError)
    end
  end
  ...
  describe '.post' do
    it 'should post to Eligible.request with proper url' do
      ...
      expect(Eligible::OriginalSignaturePdf.post(params, api_key: api_key)).to eq 'success'
    end

    it 'should raise error if enrollment npi id is not present' do
      expect { Eligible::OriginalSignaturePdf.post(params, api_key: api_key) }.to raise_error(ArgumentError)
    end
  end
  ...
  describe '.update' do
    it 'should call Eligible.request with proper url' do
      ...
      expect(Eligible::OriginalSignaturePdf.update(params, api_key: api_key)).to eq 'success'
    end

    it 'should raise error if enrollment npi id is not present' do
      expect { Eligible::OriginalSignaturePdf.update(params, api_key: api_key) }.to raise_error(ArgumentError)
    end
  end
  ...
  describe '.delete' do
    it 'should call Eligible.request with proper url' do
      ...
      expect(Eligible::OriginalSignaturePdf.delete(params, api_key: api_key)).to eq 'success'
    end

    it 'should raise error if enrollment npi id is not present' do
      expect { Eligible::OriginalSignaturePdf.delete(params, api_key: api_key) }.to raise_error(ArgumentError)
    end
  end
  ...
  describe '.download' do
    it 'should download to original_signature_pdf.pdf' do
      ...
      Eligible::OriginalSignaturePdf.download(params, api_key: api_key)
      expect(File.read('/tmp/original_signature_pdf.pdf')).to eq response.to_s
      File.delete('/tmp/original_signature_pdf.pdf')
    end

    it 'should raise error if enrollment npi id is not present' do
      expect { Eligible::OriginalSignaturePdf.download(params, api_key: api_key) }.to raise_error(ArgumentError)
    end
  end
end
