describe 'Eligible::PayerMapping' do
  ...
  describe '.mapper' do
    it 'should post to Eligible.request with proper url and headers' do
      ...
      expect(Eligible::PayerMapping.mapper(params, api_key: api_key, eligible_account: 'xyz')).to eq 'success'
    end
  ...
  describe '.mapper_batch' do
    it 'should post to Eligible.request with proper url and headers' do
      ...
      expect(Eligible::PayerMapping.mapper_batch(params, api_key: api_key, eligible_account: 'xyz')).to eq 'success'
    end
  ...
  describe '.search' do
    it 'should post to Eligible.request with proper url and headers' do
      ...
      expect(Eligible::PayerMapping.search(params, api_key: api_key, eligible_account: 'xyz')).to eq 'success'
    end
  ...
  describe '.search_batch' do
    it 'should post to Eligible.request with proper url and headers' do
      ...
      expect(Eligible::PayerMapping.search_batch(params, api_key: api_key, eligible_account: 'xyz')).to eq 'success'
    end
  ...
  describe '.normalize' do
    it 'should post to Eligible.request with proper url and headers' do
      ...
      expect(Eligible::PayerMapping.normalize(params, api_key: api_key, eligible_account: 'xyz')).to eq 'success'
    end
  ...
  describe '.normalize_batch' do
    it 'should post to Eligible.request with proper url and headers' do
      ...
      expect(Eligible::PayerMapping.normalize_batch(params, api_key: api_key, eligible_account: 'xyz')).to eq 'success'
    end
  ...
  describe '.normalize_cased' do
    it 'should post to Eligible.request with proper url and headers' do
      ...
      expect(Eligible::PayerMapping.normalize_cased(params, api_key: api_key, eligible_account: 'xyz')).to eq 'success'
    end
  ...
  describe '.normalize_cased_batch' do
    it 'should post to Eligible.request with proper url and headers' do
      ...
      expect(Eligible::PayerMapping.normalize_cased_batch(params, api_key: api_key, eligible_account: 'xyz')).to eq 'success'
    end
