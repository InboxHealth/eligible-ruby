describe 'Eligible::Precert' do
  ...
  describe '.inquiry' do
    it 'should call Eligible.request with proper url' do
      ...
      expect(Eligible::Precert.inquiry(params, api_key: api_key)).to eq 'success'
    end
  end
  ...
  describe '.require' do
    it 'should call Eligible.request with proper url' do
      ...
      expect(Eligible::Precert.require(params, api_key: api_key)).to eq 'success'
    end
  end
  ...
  describe '.create' do
    it 'should post to Eligible.request with proper url' do
      ...
      expect(Eligible::Precert.create(params, api_key: api_key)).to eq 'success'
    end
  end
end
