describe 'Eligible::Icd' do
  ...
  describe '.get' do
    it 'should call Eligible.request with proper url if type present' do
      ...
      expect(Eligible::Icd.list(params, api_key: api_key)).to eq 'success'
    end
    ...
    it 'should call Eligible.request with proper url' do
      ...
      expect(Eligible::Icd.describe(params, api_key: api_key)).to eq 'success'
    end
    ...
    it 'should call Eligible.request with proper url' do
      ...
      expect(Eligible::Icd.crosswalk(params, api_key: api_key)).to eq 'success'
    end
  end
end
